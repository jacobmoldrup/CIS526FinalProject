...
queryList ={
    ...
    'allBikes': "select b.model, b.type, b.price, b.size, b.year, b.thumbnail, c.name from BikeShop_bikes b join BikeShop_companies_bikes cb on cb.bike_id_id = b.serialNumber join BikeShop_companies c on c.code = cb.company_code_id"
}
'''
